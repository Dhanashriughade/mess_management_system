...
exports.markAbsence = async (req, res) => {
    ...
    const now = new Date();
     ...
     // ✅ Time restriction: only allow between 12:00 AM and 9:00 AM
     const currentHour = now.getHours();
     if (currentHour >= 8) {
        // return res.render("attendance", {
        //     user: req.session.user,
        //     records: [],
        //     message: "You can mark absence only between 12 AM and 8 AM."
        // });
        return res.render("attendance", {
            user: req.session.user,
            records: [],
            message: "You can mark absence only between 12 AM and 9 AM.",
